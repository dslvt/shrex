...
from modules.cf.models.yolo.utils import letterbox, make_divisible, non_max_suppression, scale_coords, xyxy2xywh
...
class Detections:
    ...
    def __init__(self, imgs, pred, names=None):
        ...
        gn = [torch.tensor([*(im.shape[i] for i in [1, 0, 1, 0]),
                           1.0, 1.0], device=d) for im in imgs]  # normalizations
