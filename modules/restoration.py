...
from modules.cf.utils import load_file_from_url, imwrite, img2tensor, tensor2img
from modules.cf.face_restoration import FaceRestoreHelper
from modules.cf.utils import is_gray
from modules.cf.rrdbnet import RRDBNet
from modules.cf.realesrgan import RealESRGANer
...
def check_ckpts():
    ...
    if not os.path.exists('../models/detection/detection_Resnet50_Final.pth'):
        load_file_from_url(
            url=pretrain_model_url['detection'], model_dir='../models/detection/', progress=True, file_name=None)
    if not os.path.exists('../models/parsing/parsing_parsenet.pth'):
        load_file_from_url(
            url=pretrain_model_url['parsing'], model_dir='../models/parsing', progress=True, file_name=None)
    if not os.path.exists('../models/realesrgan/RealESRGAN_x2plus.pth'):
        load_file_from_url(
            url=pretrain_model_url['realesrgan'], model_dir='../models/realesrgan', progress=True, file_name=None)
